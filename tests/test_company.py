...
@pytest.mark.asyncio
async def test_get_all_company_details_no_sp_status_422(mocker: MockerFixture, tests_setup_and_teardown):
    harmonic_company_not_found_error = [
        {
...
def test_lookup_company_master_id_by_domain_match(mocker: MockerFixture, tests_setup_and_teardown):
    ...
    company_entity.update(
        Company(
            id=123, name="Test", primary_domain="test.com", domains=["test.com"], sp_id="12345", crm_id="12"
...
def test_create_company_master_id(mocker: MockerFixture, tests_setup_and_teardown):
    ...
    company = Company(id=None, name="Test", primary_domain="test.com", domains=["test.com"], sp_id="12345", crm_id="12")
